...
- **Multilingual:** Native support for Go, TypeScript, Dart, Java, Kotlin, and Rust.
...
| --- | --- | --- |
| **Language support** | Usually one language or ecosystem at a time | **Polyglot** across Go, TypeScript, Dart, Java, Kotlin, and Rust |
...
TypeScript and Dart support file-shaped nodes. Go, Java, Kotlin, and Rust require directory-shaped nodes. In all languages, a bare directory glob means the exact directory, not an implicit `/**`.
